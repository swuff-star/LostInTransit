...
{
    public class BlazeDrone : LITInteractable, IContentPackModifier
    {
        ...
        {
            var request = LITAssets.LoadAssetAsync<AssetCollection>("acBlazeDrone", LITBundle.Characters);
            ...
            _characterPrefab = _assetCollection.FindAsset<GameObject>("BlazeDroneBody");
            _cardProvider = _assetCollection.FindAsset<InteractableCardProvider>("msidcBlazeDrone");
            _interactablePrefab = _assetCollection.FindAsset<GameObject>("BlazeDroneBroken");
            _characterMaster = _assetCollection.FindAsset<GameObject>("BlazeDroneMaster");
        }
