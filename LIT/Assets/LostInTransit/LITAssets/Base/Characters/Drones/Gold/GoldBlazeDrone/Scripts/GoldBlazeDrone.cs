...
{
    public class GoldBlazeDrone : LITInteractable, IContentPackModifier
    {
        ...
        {
            var request = LITAssets.LoadAssetAsync<AssetCollection>("acGoldBlazeDrone", LITBundle.Characters);
            ...
            _characterPrefab = _assetCollection.FindAsset<GameObject>("GoldBlazeDroneBody");
            _cardProvider = _assetCollection.FindAsset<InteractableCardProvider>("msidcGoldBlazeDrone");
            _interactablePrefab = _assetCollection.FindAsset<GameObject>("GoldBlazeDroneBroken");
            _characterMaster = _assetCollection.FindAsset<GameObject>("GoldBlazeDroneMaster");
        }
