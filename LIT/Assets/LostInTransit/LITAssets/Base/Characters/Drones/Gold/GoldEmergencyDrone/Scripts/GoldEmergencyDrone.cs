...
{
    public class GoldEmergencyDrone : LITInteractable, IContentPackModifier
    {
        ...
        public override void Initialize()
        {
            ...
            bodyPrefab.GetComponent<ModelLocator>().modelTransform.GetComponent<Animator>().runtimeAnimatorController = Addressables.LoadAssetAsync<RuntimeAnimatorController>("RoR2/Base/Drones/animEmergencyDrone.controller").WaitForCompletion();
        ...
        {
            var request = LITAssets.LoadAssetAsync<AssetCollection>("acGoldEmergencyDrone", LITBundle.Characters);
            ...
            _characterPrefab = _assetCollection.FindAsset<GameObject>("GoldEmergencyDroneBody");
            _cardProvider = _assetCollection.FindAsset<InteractableCardProvider>("msidcGoldEmergencyDrone");
            _interactablePrefab = _assetCollection.FindAsset<GameObject>("GoldEmergencyDroneBroken");
            _characterMaster = _assetCollection.FindAsset<GameObject>("GoldEmergencyDroneMaster");
        }
