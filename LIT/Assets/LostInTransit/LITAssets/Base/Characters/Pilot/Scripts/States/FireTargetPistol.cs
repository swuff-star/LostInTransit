...
{
    public class FireTargetPistol : BaseSkillState
    {
        public static float baseScanDuration = 0.15f;
        public static float baseScanInterval = 0.033f;
        ...
        public static string fireSoundString = "Play_lunar_golem_attack1_launch";
        ...
        private string muzzleString = "Pistol";
        ...
        public override void OnEnter()
        {
            ...
            if (!base.isGrounded) base.SmallHop(base.characterMotor, 6f);
        }
