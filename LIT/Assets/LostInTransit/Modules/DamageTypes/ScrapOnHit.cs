...
{
    public sealed class ScrapOnHit : DamageTypeBase
    {
        public override ModdedDamageType ModdedDamageType { get;  protected set; }

        public static ModdedDamageType scrapOnHit;
        ...
        private void RollScrap(DamageReport report)
        {
            ...
            if (DamageAPI.HasModdedDamageType(damageInfo, ModdedDamageType))
            {
                ...
                {
                    GameObject scrap = Object.Instantiate<GameObject>(ScrapPickup, victimBody.transform.position, victimBody.transform.rotation);
